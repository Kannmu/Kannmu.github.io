...
const copy = {
  en: {
    ...
    download: 'Download', format: 'Format', inspector: 'Inspector', alternative: 'Find another arrangement', close: 'Close', remove: 'Remove', include: 'Include', exclude: 'Exclude',
    ...
    png: 'PNG', jpeg: 'JPEG', webp: 'WebP', svg: 'SVG', exporting: 'Rendering', exportReady: 'Download ready', exportFailed: 'Export failed',
  ...
  'zh-CN': {
    ...
    download: '下载', format: '格式', inspector: '检查器', alternative: '寻找另一种排版', close: '关闭', remove: '移除', include: '参与排版', exclude: '暂不参与',
    ...
    png: 'PNG', jpeg: 'JPEG', webp: 'WebP', svg: 'SVG', exporting: '正在渲染', exportReady: '下载已生成', exportFailed: '导出失败',
