...
(function() {
    ...
    const styles = `
        ...
        .multilingual-selector.open .lang-arrow {
        ...
        .multilingual-selector.open .lang-dropdown {
            opacity: 1;
            visibility: visible;
        ...
        /* Loading state */
        .multilingual-selector.loading .lang-trigger {
            opacity: 0.7;
            pointer-events: none;
        }
        
        .multilingual-selector.loading .lang-trigger::after {
            content: '';
            position: absolute;
            top: 50%;
            right: 8px;
