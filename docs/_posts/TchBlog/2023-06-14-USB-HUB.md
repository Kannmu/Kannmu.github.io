...
description: "记录一款紧凑型 USB 2.0 扩展坞的完整设计过程，包括 FE1.1s 芯片方案、Type-C 接口、电路与 PCB 布局、外壳结构、焊接装配和实物验证。"
author: "Kannmu"
# header-style: text
...
<table>
    <tr>
        <td><center><img src = "https://p.sda1.dev/19/407ceb27f4409aa215024e89c930b7bd/Hub_Real_0.jpg" alt="USB 2.0 扩展坞实物正面" height="300"/></center></td>
        <td><center><img src = "https://p.sda1.dev/19/3d00c688d7ec398b62b1cd94730cae59/Hub_Real_1.jpg" alt="USB 2.0 扩展坞接口侧面" height="300"/></center></td>
        <td><center><img src = "https://p.sda1.dev/19/ffb47244a07198f91893d7e24af9256c/Hub_Real_2.jpg" alt="USB 2.0 扩展坞外壳细节" height="300"/></center></td>
    </tr>
</table>
...
<table>
    <tr>
        <td><center><img src = "https://p.sda1.dev/19/5eb249eb17f827a6c2b27f3d321c3d96/Hub_PCB_0.png" alt="USB 扩展坞 PCB 正面布局" width="300"/></center></td>
        <td><center><img src = "https://p.sda1.dev/19/0f8b33d4129a239cc6689d32118325a2/Hub_PCB_1.png" alt="USB 扩展坞 PCB 背面布局" width="300"/></center></td>
    </tr>
</table>
